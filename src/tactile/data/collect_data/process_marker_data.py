...
from tactile.data.utils import save_json_obj, load_json_obj
from tactile.data.collect_data.process_image_data import combine_bbox
...
if __name__ == "__main__":
    ...
    process_pin_data(BASE_DATA_PATH, dir_names, kp_process_params)
